...
The original code was released under the BSD License, as is this modified
version from https://github.com/ilastik/lazyflow/blob/master/lazyflow/utility/fileLock.py
