...
class GhostCenter:
    ...
    +------+-----------------+----------------+---------------------+
    |   15 | GetInfo         | Ghost Command  | block               |
    +------+-----------------+----------------+---------------------+
    |   16 | GetGhostStat    | Notify Command | block               |
    +------+-----------------+----------------+---------------------+
    |   17 | WaitGhostFinish | Notify Command | block               |
    +------+-----------------+----------------+---------------------+
    |   18 | GetEventStat    | Notify Command | block               |
    +------+-----------------+----------------+---------------------+
    |   19 | WaitEventFinish | Notify Command | block               |
    +------+-----------------+----------------+---------------------+
